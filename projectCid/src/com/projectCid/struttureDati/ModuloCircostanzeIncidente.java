...
public class ModuloCircostanzeIncidente {
	 ...
	 * 7: circolava su una piazza a centro rotatorio
	 * 8: tamponava procendo nello stesso senso e nella stessa fila
	...
	/**
	 * @param circostanzeIncidenteA the circostanzeIncidenteA to set
	 */
	...
	/**
	 * @param circostanzeIncidenteA[i] the circostanzeIncidenteA[i] to set
	 */	
	...
	/**
	 * @param circostanzeIncidenteB the circostanzeIncidenteB to set
	 */
	...
	/**
	 * @param circostanzeIncidenteB[i] the circostanzeIncidenteB[i] to set
	 */
	...
	public String getTipoCircostanzaIncidente(int i){
		switch (i) {
			 case 0: return"";
			 case 1: return"in fermata / in sosta";
			 case 2: return"ripartiva dopo una sosta";
			 case 3: return"stava parcheggiando";
			 case 4: return"usciva da un parcheggio, da un luogo privato, da una strada vicinale";
			 case 5: return"entrava in un parcheggio, in un luogo privato, in una strada vicinale";
			 case 6: return"si immetteva in una piazza a senso rotatorio";
			 case 7: return"circolava su una piazza a centro rotatorio";
			 case 8: return"tamponava procendo nello stesso senso e nella stessa fila";
			 case 9: return"procedeva nello stesso senso ma in una fila diversa";
			 case 10: return"cambiava fila";
			 case 11: return"sorpassava";
			 case 12: return"girava a destra";
			 case 13: return"girava a sinistra";
			 case 14: return"retrocedeva";
			 case 15: return"invadeva la sede stradale riservata alla circolazione in senso inverso";
			 case 16: return"proveniva da destra";
			 case 17: return"non aveva osservato il segnale di precedenza o di semaforo rosso";
