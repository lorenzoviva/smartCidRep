...
public class Veicolo {
	...
	/**
	 * @param checkMotoreRimorchio the checkMotoreRimorchio to set
	 */
	...
	/**
	 * @param targaOtelaio the targaOtelaio to set
	 */
	...
	/**
	 * @param paeseImmatricolazione the paeseImmatricolazione to set
	 */
