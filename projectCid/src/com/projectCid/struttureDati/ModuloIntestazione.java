...
public class ModuloIntestazione {
	...
	/**
	 * @param dataEoraIncidente the dataEoraIncidente to set
	 */
	...
	/**
	 * @param feriti the feriti to set
	 */
	...
	/**
	 * @param danniAltriVeicoli the danniAltriVeicoli to set
	 */
	...
	/**
	 * @param danniOggetti the danniOggetti to set
	 */
	...
	/**
	 * @param testimoni the testimoni to set
	 */
